...
var portalWobbleSpeed = 3, portalWobbleDist = 0.05;
...
Player.prototype.moveX = function(step, level, keys) {
  ...
  //portal moves player back
  var backXPos = this.pos.x - 10;
  var backPos = new Vector(backXPos, this.pos.y);
  if(obstacle === "portal"){
    this.pos = backPos;
  }
...
Level.prototype.playerTouched = function(type, actor) {
  ...
  //floaters give player higher jumps
  jumpSpeed = 30;
  }
  ...
  //make portal do things here
  }

  //if player touches winObj they win the Level
  else if(type == "winObj"){
    this.status = "won";
    this.finishDelay = 1;
  }
